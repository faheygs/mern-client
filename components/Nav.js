        ...
        <nav className="nav d-flex justify-content-between" style={{ backgroundColor: 'blue' }}>
            ...
            {state !== null ? (
                <div className="dropdown">
                    <a className="btn dropdown-toggle text-light" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <ul className="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        ...
                        <li>
                            <Link href='/user/messages'>
                                <a className={`nav-link dropdown-item ${current === '/user/messages' && 'active'}`} >Messages</a>
                            </Link>
                        </li>
                        <li>
